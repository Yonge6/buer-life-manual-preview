import { hasSupabaseConfig, runtimeConfig } from "../config/runtime-config.js?v=ff80ed6a5cb2c519";
import { PRODUCT_EVENT_NAMES, validateProductEvent } from "../../shared/product-event-contract.js?v=ff80ed6a5cb2c519";
