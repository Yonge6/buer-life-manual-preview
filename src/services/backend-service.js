import { hasSupabaseConfig, runtimeConfig } from "../config/runtime-config.js?v=c4b3ea943d8291ea";
import { PRODUCT_EVENT_NAMES, validateProductEvent } from "../../shared/product-event-contract.js?v=c4b3ea943d8291ea";
