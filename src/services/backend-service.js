import { hasSupabaseConfig, runtimeConfig } from "../config/runtime-config.js?v=62db5b6a05f29993";
import { PRODUCT_EVENT_NAMES, validateProductEvent } from "../../shared/product-event-contract.js?v=62db5b6a05f29993";
