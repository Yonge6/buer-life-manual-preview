import { hasSupabaseConfig, runtimeConfig } from "../config/runtime-config.js?v=5a88248da045c30c";
import { PRODUCT_EVENT_NAMES, validateProductEvent } from "../../shared/product-event-contract.js?v=5a88248da045c30c";
