import { hasSupabaseConfig, runtimeConfig } from "../config/runtime-config.js?v=cfd75dd7d2b043f3";
import { PRODUCT_EVENT_NAMES, validateProductEvent } from "../../shared/product-event-contract.js?v=cfd75dd7d2b043f3";
