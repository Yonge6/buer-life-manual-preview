import { hasSupabaseConfig, runtimeConfig } from "../config/runtime-config.js?v=6be542162b144939";
import { PRODUCT_EVENT_NAMES, validateProductEvent } from "../../shared/product-event-contract.js?v=6be542162b144939";
