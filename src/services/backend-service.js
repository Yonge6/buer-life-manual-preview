import { hasSupabaseConfig, runtimeConfig } from "../config/runtime-config.js?v=c79c223bad4d5a00";
import { PRODUCT_EVENT_NAMES, validateProductEvent } from "../../shared/product-event-contract.js?v=c79c223bad4d5a00";
