import { hasSupabaseConfig, runtimeConfig } from "../config/runtime-config.js?v=22dcd02fdf086b07";
import { PRODUCT_EVENT_NAMES, validateProductEvent } from "../../shared/product-event-contract.js?v=22dcd02fdf086b07";
