import { hasSupabaseConfig, runtimeConfig } from "../config/runtime-config.js?v=078b114d538bec96";
import { PRODUCT_EVENT_NAMES, validateProductEvent } from "../../shared/product-event-contract.js?v=078b114d538bec96";
