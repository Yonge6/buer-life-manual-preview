import { hasSupabaseConfig, runtimeConfig } from "../config/runtime-config.js?v=10ac60030e9d71da";
import { PRODUCT_EVENT_NAMES, validateProductEvent } from "../../shared/product-event-contract.js?v=10ac60030e9d71da";
