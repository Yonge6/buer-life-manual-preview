import { hasSupabaseConfig, runtimeConfig } from "../config/runtime-config.js?v=4034de6cad639197";
import { PRODUCT_EVENT_NAMES, validateProductEvent } from "../../shared/product-event-contract.js?v=4034de6cad639197";
