import { hasSupabaseConfig, runtimeConfig } from "../config/runtime-config.js?v=2ba309191101f480";
import { PRODUCT_EVENT_NAMES, validateProductEvent } from "../../shared/product-event-contract.js?v=2ba309191101f480";
