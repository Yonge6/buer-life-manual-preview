import {chatAccess,showMembership,initMembership,ensureAIConsent} from './buer-membership.js?v=f84e8cb38b7d2ef2';
import {renderAssistantText} from './buer-message-format.js?v=f84e8cb38b7d2ef2';
import {readGrowth,growthContext,answeredCount} from '../services/buer-growth.js?v=f84e8cb38b7d2ef2';
import {nextQuestionBatch} from './buer-suggestions.js?v=f84e8cb38b7d2ef2';
import {readBuerEvents,anonymousReport,validChatHistory} from '../services/buer-conversation.js?v=f84e8cb38b7d2ef2';
