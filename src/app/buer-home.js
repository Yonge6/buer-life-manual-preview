import {chatAccess,showMembership,initMembership,ensureAIConsent} from './buer-membership.js?v=bf9338632fb650db';
import {renderAssistantText} from './buer-message-format.js?v=bf9338632fb650db';
import {readGrowth,growthContext,answeredCount} from '../services/buer-growth.js?v=bf9338632fb650db';
import {nextQuestionBatch} from './buer-suggestions.js?v=bf9338632fb650db';
import {readBuerEvents,anonymousReport,validChatHistory} from '../services/buer-conversation.js?v=bf9338632fb650db';
