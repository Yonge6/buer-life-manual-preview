import {chatAccess,showMembership,initMembership,ensureAIConsent} from './buer-membership.js?v=0fe34e6e09475ffe';
import {renderAssistantText} from './buer-message-format.js?v=0fe34e6e09475ffe';
import {readGrowth,growthContext,answeredCount} from '../services/buer-growth.js?v=0fe34e6e09475ffe';
import {nextQuestionBatch} from './buer-suggestions.js?v=0fe34e6e09475ffe';
import {readBuerEvents,anonymousReport,validChatHistory} from '../services/buer-conversation.js?v=0fe34e6e09475ffe';
