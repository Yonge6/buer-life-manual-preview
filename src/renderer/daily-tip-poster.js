import { formatDailyTipText } from "../app/daily-tip.js?v=6671d420cbca7321";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, moon] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-ai-orb.webp?v=6671d420cbca7321', import.meta.url).href).catch(() => null),
