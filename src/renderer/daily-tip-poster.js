import { formatDailyTipText } from "../app/daily-tip.js?v=f84e8cb38b7d2ef2";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, hero, orb] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-aurora-hero.webp?v=f84e8cb38b7d2ef2', import.meta.url).href).catch(() => null),
    loadImage(new URL("../../assets/buer-orb-v2.png?v=f84e8cb38b7d2ef2", import.meta.url).href),
