import { formatDailyTipText } from "../app/daily-tip.js?v=182994443b5687f7";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, moon] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-ai-orb.webp?v=182994443b5687f7', import.meta.url).href).catch(() => null),
