import { formatDailyTipText } from "../app/daily-tip.js?v=8d771d31c50b2996";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, hero, orb] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-aurora-hero.webp?v=8d771d31c50b2996', import.meta.url).href).catch(() => null),
    loadImage(new URL("../../assets/buer-orb-v2.png?v=8d771d31c50b2996", import.meta.url).href),
