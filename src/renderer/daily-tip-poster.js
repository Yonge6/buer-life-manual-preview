import { formatDailyTipText } from "../app/daily-tip.js?v=f76ac3dc0c0ea7bb";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, hero, orb] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-aurora-hero.webp?v=f76ac3dc0c0ea7bb', import.meta.url).href).catch(() => null),
    loadImage(new URL("../../assets/buer-orb-v2.png?v=f76ac3dc0c0ea7bb", import.meta.url).href),
