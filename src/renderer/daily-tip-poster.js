import { formatDailyTipText } from "../app/daily-tip.js?v=987c52c5cf31c122";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, moon] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-ai-orb.webp?v=987c52c5cf31c122', import.meta.url).href).catch(() => null),
