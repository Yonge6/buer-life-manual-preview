import { formatDailyTipText } from "../app/daily-tip.js?v=afb330d7b45e53bb";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, hero, orb] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-aurora-hero.webp?v=afb330d7b45e53bb', import.meta.url).href).catch(() => null),
    loadImage(new URL("../../assets/buer-orb-v2.png?v=afb330d7b45e53bb", import.meta.url).href),
