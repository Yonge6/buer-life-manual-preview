import { formatDailyTipText } from "../app/daily-tip.js?v=0159216f3d0edc32";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, moon] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-ai-orb.webp?v=0159216f3d0edc32', import.meta.url).href).catch(() => null),
