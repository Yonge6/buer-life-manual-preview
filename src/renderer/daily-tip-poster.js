import { formatDailyTipText } from "../app/daily-tip.js?v=0375141c474e1601";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, hero, orb] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-aurora-hero.webp?v=0375141c474e1601', import.meta.url).href).catch(() => null),
    loadImage(new URL("../../assets/buer-orb-v2.png?v=0375141c474e1601", import.meta.url).href),
