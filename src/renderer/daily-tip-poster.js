import { formatDailyTipText } from "../app/daily-tip.js?v=7cf12b13942f385b";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, moon] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-ai-orb.webp?v=7cf12b13942f385b', import.meta.url).href).catch(() => null),
