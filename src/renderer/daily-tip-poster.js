import { formatDailyTipText } from "../app/daily-tip.js?v=c1bc7f2c3578046b";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, hero, orb] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-aurora-hero.webp?v=c1bc7f2c3578046b', import.meta.url).href).catch(() => null),
    loadImage(new URL("../../assets/buer-orb-v2.png?v=c1bc7f2c3578046b", import.meta.url).href),
