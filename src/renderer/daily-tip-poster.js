import { formatDailyTipText } from "../app/daily-tip.js?v=ff80ed6a5cb2c519";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, hero, orb] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-aurora-hero.webp?v=ff80ed6a5cb2c519', import.meta.url).href).catch(() => null),
    loadImage(new URL("../../assets/buer-orb-v2.png?v=ff80ed6a5cb2c519", import.meta.url).href),
