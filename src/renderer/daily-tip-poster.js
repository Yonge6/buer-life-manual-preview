import { formatDailyTipText } from "../app/daily-tip.js?v=2ba309191101f480";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, moon] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-ai-orb.webp?v=2ba309191101f480', import.meta.url).href).catch(() => null),
