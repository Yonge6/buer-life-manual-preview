import { formatDailyTipText } from "../app/daily-tip.js?v=13680a80e1076253";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, moon] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-ai-orb.webp?v=13680a80e1076253', import.meta.url).href).catch(() => null),
