import { formatDailyTipText } from "../app/daily-tip.js?v=97874b28f0bc9725";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, moon] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-ai-orb.webp?v=97874b28f0bc9725', import.meta.url).href).catch(() => null),
