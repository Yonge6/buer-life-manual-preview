import { formatDailyTipText } from "../app/daily-tip.js?v=76de70bf9f29f79a";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, moon] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-ai-orb.webp?v=76de70bf9f29f79a', import.meta.url).href).catch(() => null),
