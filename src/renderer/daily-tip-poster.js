import { formatDailyTipText } from "../app/daily-tip.js?v=23ad4682e3f92469";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, moon] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-ai-orb.webp?v=23ad4682e3f92469', import.meta.url).href).catch(() => null),
