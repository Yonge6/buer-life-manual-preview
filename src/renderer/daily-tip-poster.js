import { formatDailyTipText } from "../app/daily-tip.js?v=68d3478d3beec6e7";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, moon] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-ai-orb.webp?v=68d3478d3beec6e7', import.meta.url).href).catch(() => null),
