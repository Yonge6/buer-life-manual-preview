import { formatDailyTipText } from "../app/daily-tip.js?v=96604723aa50efff";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, hero, orb] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-aurora-hero.webp?v=96604723aa50efff', import.meta.url).href).catch(() => null),
    loadImage(new URL("../../assets/buer-orb-v2.png?v=96604723aa50efff", import.meta.url).href),
