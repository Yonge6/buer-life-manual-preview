import { formatDailyTipText } from "../app/daily-tip.js?v=bf9338632fb650db";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, hero, orb] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-aurora-hero.webp?v=bf9338632fb650db', import.meta.url).href).catch(() => null),
    loadImage(new URL("../../assets/buer-orb-v2.png?v=bf9338632fb650db", import.meta.url).href),
