import { formatDailyTipText } from "../app/daily-tip.js?v=416c42fd17d2438f";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, hero, orb] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-aurora-hero.webp?v=416c42fd17d2438f', import.meta.url).href).catch(() => null),
    loadImage(new URL("../../assets/buer-orb-v2.png?v=416c42fd17d2438f", import.meta.url).href),
