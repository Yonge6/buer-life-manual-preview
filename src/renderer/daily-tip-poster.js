import { formatDailyTipText } from "../app/daily-tip.js?v=b62d04d9762d8200";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, moon] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-ai-orb.webp?v=b62d04d9762d8200', import.meta.url).href).catch(() => null),
