import { formatDailyTipText } from "../app/daily-tip.js?v=0efb9b7c3cf49fbc";
...
export async function createDailyTipPoster({ tip, language, date = new Date() }) {
  ...
  const [qr, moon] = await Promise.all([
    ...
    loadImage(new URL('../../assets/buer-ai-orb.webp?v=0efb9b7c3cf49fbc', import.meta.url).href).catch(() => null),
